...
curl -X DELETE "$self_triggers_host/$self_triggers_share_id/targets/$self_triggers_share_target_id?version=2022-05-03&generation=2" -H "Authorization: $oauth_token"