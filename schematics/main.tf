...
module "ansible-deployment" {
  ...
  depends_on	= [ module.app-vsi, local_file.ansible_inventory, local_file.ha_ansible_infra-vars, local_file.app_ansible_saps4app-vars, local_file.db_ansible_saphana-vars, module.file-shares-cleaning-up, module.dns ]
